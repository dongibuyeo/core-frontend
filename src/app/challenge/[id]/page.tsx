  ...
  return (
    <div className="w-full h-full">
      <Image
        ...
        height={400}
        width={400}
        className="w-full aspect-square object-cover object-center fixed top-0 left-0"
      />
      <div className="fixed top-0 left-0 w-full aspect-square bg-gradient-to-b from-black to-transparent opacity-20" />
      <div className="relative z-50">
        <div className="w-full aspect-4-3" />
        <div className="w-full rounded-t-[2rem] bg-white">
          <div className="flex">
            <button type="button" className="w-1/2 py-5 font-medium">
              <span className="border-b-2 border-black leading-5">
                챌린지 정보
              </span>
            </button>
            <button type="button" className="w-1/2 py-5 font-normal">
              <span>현재랭킹</span>
            </button>
          </div>
          <div className="px-5 flex flex-col gap-[3.75rem]">
            ...
            <div>
              ...
              <div className="bg-_grey-100 w-full p-4 mt-4 text-center rounded-xl text-sm font-normal">
                ...
                <p className="mt-5">
                  다음 달 &lt;카페&gt; 소비가{' '}
                  <span className="text-medium text-primary">75,400</span>원
                  미만이면 성공이에요!
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              >
                <div className="w-full flex flex-col items-center">
                  ...
                  <div
                    className={`w-auto flex flex-col gap-2 overflow-hidden transition-max-height duration-200 ease-in-out ${
            ...
            <Button text="참여하기" className="text-white mb-9" />
          </div>
        </div>
      </div>
    </div>
